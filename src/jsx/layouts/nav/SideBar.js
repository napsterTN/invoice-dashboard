    ...
    >
      <PerfectScrollbar className="dlabnav-scroll">
			  ...
			  <Dropdown.Toggle variant="" as="a" className="nav-link i-false c-pointer">
				<div className="header-info2 d-flex align-items-center border">
				  ...
				  <div className="d-flex align-items-center sidebar-info">
					<div>
					  <span className="font-w700 d-block mb-2">Majdi Njim</span>
		...
		<div className="copyright">
			<p><strong>Invoice Admin Dashboard</strong> © 2022 All Rights Reserved</p>
			<p className="fs-12">Made with <span className="heart"></span> by Updev Technologies</p>
		</div>
      </PerfectScrollbar>
    </div>
  );
